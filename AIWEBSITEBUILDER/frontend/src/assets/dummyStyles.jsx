...
export const githubModalStyles = {
    ...
    visibilityBtn: (active) =>
        `flex items-start gap-2.5 text-left p-3 rounded-lg border transition ${active ? "border-indigo-500/50 bg-indigo-500/8" : "border-white/8 bg-white/2 hover:bg-white/4"
        }`,
